...
# Contact: nikitackb456@gmail.com
...
bucket_name="dev1-ultimate-bucket"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="nikitackb456@gmail.com"
...
aws sns publish \
  ...
  --message "Hey people ,this is Nikita verma and this is my first devops project on aws event triggering"
